...
def gen_TCL_data( Nlayer, Nsegment, NsegmentObs, Ncomp, NonLin='leaky', LinType='uniform', negSlope=.2, Niter4condThresh =1e4, varyMean=False):
  """
  ...
  return {'source': dat, 'obs': mixedDat, 'labels': labels}
