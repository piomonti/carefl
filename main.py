...
def parse_input():
    ...
    parser.add_argument('--dataset', type=str, default='linear', help='Dataset to run synthetic experiments on. Should be either linear, hoyer2009 or nueralnet_l1 or all to run all')
